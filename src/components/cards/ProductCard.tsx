      ...
      >
        <div className="relative aspect-[4/5] overflow-hidden bg-sand">
          <Image
            ...
            placeholder="blur"
            blurDataURL={BLUR}
            className="object-cover transition-[opacity,transform] duration-[900ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-[1.04] group-hover:opacity-0"
          />
          ...
          <Image
            ...
            quality={80}
            loading="lazy"
            className="scale-[1.06] object-cover opacity-0 transition-[opacity,transform] duration-[900ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-100 group-hover:opacity-100"
          />

          {/* Detail strip slides up from the base of the frame. */}
          <div className="pointer-events-none absolute inset-x-0 bottom-0 translate-y-full bg-porcelain/95 px-5 py-4 transition-transform duration-[700ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-y-0">
